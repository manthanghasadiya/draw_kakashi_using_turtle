...
class Kakashi:
    def __init__(self):
        self.dot1 = [(276, 257), (274, 258), 
                    (273, 260), (274, 261), 
                    (276, 262), (278, 261), 
                    (279, 259), (278, 258)]
        self.dot2 = [(274, 273), (272, 274), 
                    (272, 276), (274, 277), 
                    (276, 277), (277, 275), 
                    (277, 274)]
        self.dot3 = [(276, 287), (274, 289), 
                    (275, 291), (278, 291),
                    (279, 289), (278, 288),
                    (275, 288)]
        self.dot4 = [(378, 273), (381, 274), 
                    (380, 277), (377, 277), 
                    (376, 275), (377, 274), 
                    (380, 273), (381, 276)]
        self.dot5 = [(375, 288), (377, 288), 
                    (379, 290), (378, 292), 
                    (376, 293), (375, 292), 
                    (374, 290), (379, 289)]
        self.face = [(252, 297), (256, 318), 
                    (258, 333), (262, 349), 
                    (277, 351), (291, 349), 
                    (305, 344), (317, 337), 
                    (331, 329), (346, 336), 
        ...
        self.hidden_leaf = [(327, 282), 
                    ...
                    (341, 270), (344, 267), 
                    (345, 265)]
        self.inner_eye = [(366, 316), 
                    (368, 316), (367, 317)]
        self.left_ear = [(251, 297), 
                    (242, 293), (241, 298), 
                    (240, 325), (247, 337), 
                    (255, 348), (259, 351), 
                    (261, 350), (259, 337), 
        ...
        self.left_eye_ball = [(287, 315), 
                    (287, 318), (289, 321), 
                    (293, 323), (296, 323), 
                    (298, 322), (300, 320), 
                    (301, 318), (301, 316), 
                    (294, 315), (287, 315)]
        self.left_eye = [(275, 317), 
                    (279, 315), (286, 315), 
                    (294, 315), (303, 316), 
                    (311, 318), (308, 318), 
                    (311, 321), (305, 324), 
                    ...
                    (286, 325), (282, 324), 
                    (278, 321), (275, 317)]
        self.left_eye_curve = [(317, 321), 
                    (319, 324), (316, 327), 
                    (312, 330)]
        self.left_eyebrow = [(292, 305), 
                    (300, 306), (308, 307), 
                    (322, 318), (303, 311), 
                    (296, 310), (287, 310), 
                    (280, 311), (275, 313), 
        ...
        self.mask = [(262, 351), (268, 372), 
                    ...
                    (286, 351), (272, 352), 
                    (262, 350)]
        self.nose_shadow = [(339, 374), 
                    (335, 374), (332, 374), 
                    (328, 373), (331, 378), 
                    (337, 379), (338, 377)]
        self.nose = [(338, 356), (340, 360), 
                    (342, 365), (344, 369), 
                    (342, 373), (338, 376)]
        self.right_ear = [(406, 295), 
                    (410, 290), (415, 291), 
                    (417, 296), (418, 307), 
                    (419, 319), (415, 332), 
                    (410, 344), (405, 351), 
        ...
        self.right_eye_ball = [(361, 316), 
                    ...
                    (368, 315), (365, 315), 
                    (362, 315), (361, 317)]
        self.right_eye_curve = [(345, 321), 
                    (342, 324), (346, 328), 
                    (349, 330)]
        self.right_eye = [(350, 320), 
                    (353, 317), (356, 316), 
                    (349, 317), (360, 315), 
                    (378, 315), (384, 315), 
                    (382, 320), (378, 323), 
